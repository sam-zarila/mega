         ...
         <div class="row mtop10">
            ...
            <div class="col-md-9 _buttons">
               ...
               <div class="pull-right">
                  ...
                  <a href="<?php echo admin_url('bills/invoice/'.$invoice->id); ?>" data-toggle="tooltip" title="<?php echo _l('edit_invoice_tooltip'); ?>" class="btn btn-default btn-with-tooltip" data-placement="bottom"><i class="fa fa-pencil-square-o"></i></a>
                  <?php } ?>
                  <div class="btn-group">
                  ...
                  <div class="btn-group">
                     ...
                     <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li>
                           <a href="<?php echo admin_url('bills/copy/'.$invoice->id); ?>"><?php echo _l('invoice_copy'); ?></a>
                        </li>
                        <?php } ?>
