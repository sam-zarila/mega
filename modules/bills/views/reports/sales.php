      ...
      <div class="row">
         <div class="col-md-12">
            <div class="panel_s">
               <div class="panel-body">
                  <div class="row">
                     <div class="col-md-4 border-right">
                      ...
                      <hr class="hr-10" />
                      <p>
                        <a href="#" class="font-medium" onclick="init_report(this,'bills-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> Relatório de Contas a Pagar</a>
                      </p>
                        <hr class="hr-10" />
                      <p>
               ...
               <?php $this->load->view('admin/reports/includes/bills_income'); ?>
               ...
               <?php $this->load->view('admin/reports/includes/sales_bills'); ?>
