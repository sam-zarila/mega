...
<div class="widget" id="widget-<?php echo basename(__FILE__,".php"); ?>" data-name="Contas a Pagar vs Renda">
   <?php if(has_permission('payments','','view') || has_permission('invoices','','view_own')){ ?>
   <div class="row" id="bills_report">
      <div class="col-md-12">
         <div class="panel_s">
            <div class="panel-body padding-10">
               <div class="widget-dragger"></div>
               <div class="col-md-12">
                  <p class="pull-left mtop5">Contas a Pagar vs Renda</p>
                  ...
                  <?php if (is_using_multiple_currencies()) { ?>
                   ...
                   <?php } ?>
                   <canvas height="130" style="max-height:500px;" id="bills-stats"></canvas>
                   <div class="clearfix"></div>
                </div>
             </div>
          </div>
