...
<div class="col-md-4 period hide">
	<?php echo render_date_input('period-from','','',array('onchange'=>isset($onChange) ? $onChange : '','placeholder'=>_l('from_date'))); ?>
</div>
<div class="col-md-4 period hide">
	<?php echo render_date_input('period-to','','',array('onchange'=>isset($onChange) ? $onChange : '','placeholder'=>_l('to_date'))); ?>
</div>
